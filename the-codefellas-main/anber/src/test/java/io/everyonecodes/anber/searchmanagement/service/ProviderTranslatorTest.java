...
class ProviderTranslatorTest {
    ...
    private ProviderDTO dto = new ProviderDTO(1L, "austria", ProviderType.INTERNET, "providerName", List.of(), "tariffName", 0.5, ContractType.SIX_MONTHS, PriceModelType.PER_CONSUMPTION, "website.com", "test@email.com", "0123 456789", false, new Rating(Set.of(), "4.5"));
    ...
    void DtoToVerifiedAccount() {
        ...
        var expected = new VerifiedAccount(1L, "providerName", "website.com", "test@email.com", "0123 456789", true, List.of(), new Rating(Set.of(), "4.5"));
    ...
    void DtoToUnverifiedAccount() {
        var expected = new UnverifiedAccount(1L, "providerName", "website.com", false, List.of(), new Rating(Set.of(), "4.5"));
    ...
    void unverifiedToVerifiedAccount() {
        var unverified = new UnverifiedAccount(1L, "providerName", "website.com", false, List.of(), new Rating(Set.of(), "4.5"));
    ...
    void verifiedToUnverifiedAccount() {
        var verified = new VerifiedAccount(1L, "providerName", "website.com", "test@email.com", "0123 456789", false, List.of(), new Rating(Set.of(), "4.5"));
    ...
    @Test
    void DtoToPublic() {
        var expected = new ProviderPublic("providerName", "website.com", new Rating(Set.of(), "4.5"), List.of());
