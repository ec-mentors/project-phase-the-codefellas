...
public class UserEndpoint {
    ...
    public UserEndpoint(UserService userService, EmailService emailService, UserRepository userRepository) {
    ...
    User registerUser(@Valid @RequestBody User user) {
        ...
        if (userRepository.existsByEmail(user.getEmail())) {
            throw new ResponseStatusException(
                    HttpStatus.CONFLICT, "User with given email-address already exists");
        }
